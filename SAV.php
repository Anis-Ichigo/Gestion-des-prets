                ...
                <div class="collapse navbar-collapse " id="navbarText">
                    ...
                    ?>
                            ...
                            machine</a>
                                ...
                                <li class="nav-item  text-center">
                                    <a class="nav-link " aria-current="page" href="reservation_portable.php"><i
                                class=" fi-rr-add"></i> Nouvelle réservation</a>
                                </li>
                                <li class="nav-item  text-center">
                                    <a class="nav-link" href="mes_reservations.php"><i class="fi-rr-file-check"></i> Mes
                            réservations</a>
                    ...
                    <div class="mycharts-heading">
                        <div class="element-head">
                            ...
                            <a href="deconnexion.php" type="button" class="btn btn-default"><i
                                    class="fi-rr-sign-out"></i></a>
                        </div>
                    </div>
                </span>
                </div>
        ...
        <div class="contenu">
            ...
            <Table class="table table-striped table-hover">
                ...
                <TR>
                    ...
                    <TD>
                        Je n'arrive pas à activer ma clef
                    </TD>
                    <td>
